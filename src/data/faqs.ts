...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/doncaster/" class="text-primary hover:underline">Doncaster</a> and South Yorkshire. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/doncaster/" class="text-primary hover:underline">Doncaster</a> and South Yorkshire, including <a href="/locations/rotherham/" class="text-primary hover:underline">Rotherham</a>, <a href="/locations/barnsley/" class="text-primary hover:underline">Barnsley</a>, <a href="/locations/scunthorpe/" class="text-primary hover:underline">Scunthorpe</a>, Thorne, Mexborough, Conisbrough, Hatfield, and Bawtry. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
